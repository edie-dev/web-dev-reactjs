...
<img src={client1} alt="" className='w-[130px] cursor-pointer transition-all' />
<img src={client2} alt="" className='w-[130px] cursor-pointer transition-all' />
<img src={client3} alt="" className='w-[130px] cursor-pointer transition-all' />
<img src={client4} alt="" className='w-[130px] cursor-pointer transition-all' />
<img src={client5} alt="" className='w-[130px] cursor-pointer transition-all' />
<img src={client6} alt="" className='w-[130px] cursor-pointer transition-all' />
    ...
    {/* scroll to top button */}
      ...
      <div id='icon-box' className=' bg-themepurple text-white p-3 rounded-full hover:bg-themeyellow
       hover:text-black cursor-pointer fixed lg:bottom-6 right-6 bottom-6'>
