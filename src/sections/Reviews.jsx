...
const Reviews = () => {
  ...
  return (
    <div id='testimonials' className='w-full lg:px-20 lg:px-5 py-[80px] bg-gray-100 flex flex-col
    justify-center items-center gap-4'>
      <h1 data-aos="zoom-in" data-aos-delay="100" className='text-themepurple text-xl 
      font-semibold capitalize'>1300+ Customer Reviews</h1>
      <h1 data-aos="zoom-in" data-aos-delay="200" className='text-black font-semibold text-[42px]
      leading-[50px] text-center capitalize'>Our Customer Love</h1>
      <div data-aos="zoom-in" data-aos-delay="100" className='w-full mt-10'>
        ...
        reviewdata.map((item, index) => (
          <div>
            ...
            lg:p-10 p-3'>
              <img src={item.img} alt="" className='rounded-full w-[200px] m-auto'/>
