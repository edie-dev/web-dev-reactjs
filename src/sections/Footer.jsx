...
const Footer = () => {
  ...
  return (
    ...
    {/* 1st box starts here */}
    <div data-aos="zoom-in" data-aos-delay="100" className='w-full bg-themepurple lg:px-20 px-10 py-8 grid 
    lg:grid-cols-6 grid-cols-2 justify-center items-center gap-10 border-8 border-red-500'>
      <img src={client1} alt="Client" className='w-[130px] cursor-pointer hover:brightness-110 border border-white/20 rounded-lg hover:border-white transition-all' />
<img src={client2} alt="" className='w-[130px] cursor-pointer hover:brightness-110 border border-white/20 rounded-lg hover:border-white transition-all' />
<img src={client3} alt="" className='w-[130px] cursor-pointer hover:brightness-110 border border-white/20 rounded-lg hover:border-white transition-all' />
<img src={client4} alt="" className='w-[130px] cursor-pointer hover:brightness-110 border border-white/20 rounded-lg hover:border-white transition-all' />
<img src={client5} alt="" className='w-[130px] cursor-pointer hover:brightness-110 border border-white/20 rounded-lg hover:border-white transition-all' />
<img src={client6} alt="" className='w-[130px] cursor-pointer hover:brightness-110 border border-white/20 rounded-lg hover:border-white transition-all' />
    ...
    <div className='w-full lg:px-20 px-5 py-[40px] bg-gray-100'>
      ...
      <div className='lg:w-[60%] w-full flex lg:flex-row flex-col justify-center items-center gap-4 flex-grow'>
        ...
        <div>
          ...
          <button className='bg-themepurple lg:w-auto w-full text-white hover:bg-themeyellow hover:text-black px-6 py-3 rounded-r-lg
    ...
    {/* scroll to top button */}
      ...
      <div id='icon-box' className='bg-themepurple text-white p-3 rounded-full hover:bg-themeyellow hover:text-black cursor-pointer
      fixed lg:bottom-6 right bottom-6'>
